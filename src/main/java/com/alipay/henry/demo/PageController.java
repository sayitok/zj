...
public class PageController {
    ...
    public static final String[] TITLES = {"id","研究中心","姓名","性别","出生日期","CKD病史","高血压病史","糖尿病病史","心脑血管病史",
                ...
                "红细胞数","血常规白细胞数","血常规中性细胞数","血常规血小板","血肌酐","血红蛋白","iPTH","血钙",
                "血磷","头颅CT脑梗塞","心脏彩超","房间隔","左房大小","左室大小","室间隔厚度","左室后壁厚度","射血分数","瓣膜钙化"};
